...
- 技术栈为 Java 系（见 `docs/project-profile.md` 技术栈字段）且业务改动命中专项区域（分布式锁、MyBatis、Controller / OpenAPI、错误码 / i18n、异步、防腐层、事务、服务结构、测试）时，按 `AGENTS.md` 0.3 门禁读取对应 `tools/skills/java-*` SKILL.md
