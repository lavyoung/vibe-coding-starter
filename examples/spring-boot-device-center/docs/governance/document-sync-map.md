...
| 代码模块 | 必须同步的文档 | 同步动作 |
|---|---|---|
| `src/main/java/**/controller/**` | `docs/api/v1.2.0/device-admin-api.yaml` + `docs/design/v1.2.0/device-image-upload.md` | 接口行为变化时同步 API 和设计 |
...
| `src/main/resources/db/migration/**` | `docs/sql/v1.2.0/device-schema.md` + `docs/upgrade/v1.2.0/device-image-upload.md` + `docs/design/v1.2.0/device-image-upload.md` | schema 或迁移步骤变化时同步表结构、升级说明和设计 |
